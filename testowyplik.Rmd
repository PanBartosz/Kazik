...
library(dplyr)
data <- read.csv("Fri Jul 31 01:25:00 2015/cleanData28553.csv")
...
data2 <- read.csv("Fri Jul 31 00:51:49 2015/cleanKasiaBartosz2169464.csv")
...
barchart(RESPONSE ~ GROUP + ADVERB ,data = xtable, horizontal = 0, stack = TRUE, layout=c(8,2))
detach(data)
```
