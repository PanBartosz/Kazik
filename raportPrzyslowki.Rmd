...
xtable[1:2,1:2,3] <- prop.table(xtable[1:2,1:2,1],3)
xtable[1:2,1:2,4] <- prop.table(xtable[1:2,1:2,1],4)
xtable[1:2,1:2,5] <- prop.table(xtable[1:2,1:2,1],5)
xtable[1:2,1:2,6] <- prop.table(xtable[1:2,1:2,1],6)
xtable[1:2,1:2,7] <- prop.table(xtable[1:2,1:2,1],7)
xtable[1:2,1:2,8] <- prop.table(xtable[1:2,1:2,1],8)
